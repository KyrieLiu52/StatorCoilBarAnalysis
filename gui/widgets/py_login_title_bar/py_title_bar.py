...
class PyLoginTitleBar(QWidget):
    ...
    def setup_ui(self):
        ...
        self.logo_png.setPixmap(QPixmap(self._logo_image))
        self.logo_png.setScaledContents(True)
        self.top_logo_layout.addWidget(self.logo_png, Qt.AlignCenter, Qt.AlignCenter)
